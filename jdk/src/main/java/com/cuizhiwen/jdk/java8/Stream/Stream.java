package com.cuizhiwen.jdk.java8.Stream;
...
public class Stream {
    /**
     * 一 ：Java 8 API添加了一个新的抽象称为流Stream，可以让你以一种声明的方式处理数据。
     ...
     *
     * 四：和以前的Collection操作不同， Stream操作还有两个基础的特征：
     ...
     *          String mergedString = string
     *
     *
     *
     *          s.stream().filter(string -> !string.isEmpty()).collect(Collectors.joining(", "));
